...
echo "export SSH_REMOTE_USER=`aws --region eu-west-2 ssm get-parameter --name mock_sftp_ftp_server_sftp_username --query 'Parameter.Value' --output text --with-decryption`
